...
Independent of the type of project, you will have to write a **Final Reflection where you propose and justify a mark for yourself based on your experience with the course and with working on you Group Projec**t. Note that your mark suggestion is just a suggestion and the tutors and I will make the final decision. You should follow the marking rubric in @sec-rubric below. This reflection is what you submit to Turnitin on Learn by the deadline of Thursday 12th December. The reflection should contain the "product" of your Group Project, either as text following the reflection or as a link (since the Group Project can be any of different types of products).
