...
-   You can create **interactive plots with plotly**: for example, [https://plotly.com/r/line-and-scatter/](https://plotly.com/r/line-and-scatter/) Even interactive 3D plots: [https://stefanocoretta.github.io/post/rgb-space/](https://stefanocoretta.github.io/post/rgb-space/). Do not make static 3D plots, they are difficult to read. See [Interactive plots](plot-plotly.qmd).
