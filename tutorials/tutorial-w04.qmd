...
Let's create a new column that states whether a consonant is voiced or voiceless. Because we're modifying the data frame, let's go back to the R Markdown file of the tutorial and keep on writing code there.
