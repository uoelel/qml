...
To download the file with the data right-click on the following link and download the file: [shallow.csv](../data/shallow.csv). (Note that tutorial files are also linked in the [Syllabus](../content.qmd))
