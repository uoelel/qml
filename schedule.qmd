...
-   Read [Research methods and hodotics](posts/hodotics.qmd).
...
-   Pick and read any entry/ies from the [Notebook](notebook.qmd).
...
-   Read [Research questions and hypotheses](posts/research-qh.qmd) (make sure you read the pre-requisites too!).
...
-   Read [Inference and uncertainty](posts/inference.qmd) (make sure you read the pre-requisites too!).

-   Pick and read any entry/ies from the [Notebook](notebook.qmd).

-   Feel free to read from any other source, including the recommended textbooks.
