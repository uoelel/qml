...
The emojis next to the lectures from Week 2 on indicate whether the lecture contains group activities 🎮 or whether it is a standard frontal lecture 👨‍🏫.
Note that all lectures will have a standard lecture component at varying rates to accompany the activities.
...
| 3 | 🎮 [Inference, uncertainty and variability](lectures/week-03.qmd) | [Summarise, count and group data](workshops/week-03.qmd) |  |
| 4 | 🎮 [Questionable Research Practices](lectures/week-04.qmd) | [Plot basics](workshops/week-04.qmd) | Self-reflection |
| 5 | 👨‍🏫 [Intro to statistical modelling](lectures/week-05.qmd) | [Gaussian models with brms](workshops/week-05.qmd) |  |
...
| 8 | 👨‍🏫 [Bernoulli regression](lectures/week-08.qmd) | [Bernoulli and log-normal regression](workshops/week-08.qmd) | Group project proposal |
...
- This includes not only reading the text, but also completing all accompanying R/RStudio activities, code examples, installation steps, exercises, and quizzes as you encounter them.
- **Read the Preface and the Week 2 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) and complete any activity in those chapters.**
- Note that [Chapter 4](https://stefanocoretta.github.io/qdal/ch-r-rstudio.html) includes instructions on installing R and RStudio.
:::
...
- Read the Week 3 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) and complete any activity in those chapters.
:::
...
- Read the Week 4 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) and complete any activity in those chapters.
:::
...
- Read the Week 5 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) and complete any activity in those chapters.
- Note that [Chapter 22](https://stefanocoretta.github.io/qdal/ch-fit-model.html) includes instructions on installing brms and extra software. Installation can take a long time. **If you have any issues with installing the necessary software**, I will run a drop-in session on **Tuesday 20th October from 10.30am to 12.00** in my office. You don't need to book, just show up.
:::
...
- Fit regression models of the form $y \sim x$\$y \\sim x\$ with brms in R.
...
- Read the Week 7 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) and complete any activity in those chapters.
:::
...
- Read the Week 8 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) and complete any activity in those chapters.
:::
...
- Read the Week 9 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) and complete any activity in those chapters.
:::
...
- Read the Week 10 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) and complete any activity in those chapters.
:::
