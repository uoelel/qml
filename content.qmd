...
The following table is a schedule overview of the course, with the topic of the lecture, workshop and assessments due.
See [Assessments](assessments.qmd) for more info on assessment.
...
| 6 | [Regression basics with brms](lectures/week-06.qmd) | [Regression basics and posteriors draws](workshops/week-06.qmd) | Self-reflection + Quiz 1 |
| 7 | [Null Ritual](lectures/week-07.qmd) | [Categorical predictors in regression](workshops/week-07.qmd) |  |
...
Go through [Chapter 4](https://stefanocoretta.github.io/qdal/ch-r-rstudio.html) and [Chapter 5](https://stefanocoretta.github.io/qdal/ch-packages.html) of the course [textbook](https://stefanocoretta.github.io/qdal/).
You will start working in groups from next week since this week is probably easier to read and try things out solo, but feel free to work in group if it works for you!
...
- [Workshop instructions](workshops/week-04.qmd).
:::
...
You should complete Quiz 1 this week, to check your learning before moving on onto the second part of the course.
...
- Read the Week 5 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/).
- **Remember that you ARE expected to have completed this week's readings before this week's Workshop!** This means that you very likely have to start the readings of each week in the previous week.
:::
...
- [Lecture slides](lectures/week-05.qmd).
:::

::: {.callout-tip collapse="false"}
#### Workshop

- [Workshop instructions](workshops/week-05.qmd).
:::
...
- Read the Week 7 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/).
- **Remember that you ARE expected to have completed this week's readings before this week's Workshop!** This means that you very likely have to start the readings of each week in the previous week.
:::
...
- [Lecture slides](lectures/week-07.qmd).
:::

::: {.callout-tip collapse="false"}
#### Workshop

- [Workshop instructions](workshops/week-07.qmd).
:::
...
- **Read [Ch 30](https://stefanocoretta.github.io/qdal/ch-regression-bernoulli.html) of the textbook before the lecture.**
- Read the other Week 8 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) **before this week's Workshop!** This means that you very likely have to start the readings of each week in the previous week.
:::

::: {.callout-tip collapse="false"}
#### Lecture

- [Lecture slides](lectures/week-08.qmd).
:::

::: {.callout-tip collapse="false"}
#### Workshop

- [Workshop instructions](workshops/week-08.qmd).
:::
...
- **Read** [Ch 33](https://stefanocoretta.github.io/qdal/ch-open-research.html) **of the textbook before the lecture.**
- Read the other Week 9 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/) **before this week's Workshop!** This means that you very likely have to start the readings of each week in the previous week.
:::

::: {.callout-tip collapse="false"}
#### Lecture

- [Lecture slides](lectures/week-09.qmd).
:::

::: {.callout-tip collapse="false"}
#### Workshop

- [Workshop instructions](workshops/week-09.qmd).
:::
...
- Read the other Week 10 chapters of the course [textbook](https://stefanocoretta.github.io/qdal/).
:::

::: {.callout-tip collapse="false"}
#### Lecture

- [Lecture slides](lectures/week-10.qmd).
:::

::: {.callout-tip collapse="false"}
#### Workshop

This week's workshop is dedicated to your group project work.
Depending on the nature of your project, you can use the time to discuss any aspect of the project, working on the data analysis, writing your essay, or anything else is relevant to your project.
:::
...
You should complete Quiz 2 this week, to check your learning before moving on onto the second part of the course.
