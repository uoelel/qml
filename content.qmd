...
| 3 | Inference and uncertainty | Summarise, count and group data |  |
| 4 | Questionable Research Practices | Plot basics | Self-reflection |
| 5 | Bayesian inference | Gaussian models with brms |  |
| 6 | Regression basics with brms | Regression basics and posteriors draws | Self-reflection + Quiz 1 |
| 7 | Null Ritual | Categorical predictors in regression |  |
| 8 | Bernoulli regression | Bernoulli regression | Group project proposal |
