...
-   Fit a regression model to answer the following question: do different vowels have different durations?

-   Write a paragraph reporting the model. Produce plots of the posterior distributions of the model parameters and the posterior predictions for each vowel.
...
-   Write a paragraph reporting the model. Produce plots of the posterior distributions of the model parameters and the posterior predictions for the dense and sparse condition.
...
-   Write a paragraph reporting the model. Produce plots of the posterior distributions of the model parameters and the posterior predictions for each relation type.
